                            ...
                            <div class="form-panel">
                                ...
                                <form class="form-horizontal style-form" action="add-speaker-action.php" method="POST">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="spfirstname" id="spfirstname" pattern="{1,}" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 col-sm-2 control-label">Speaker Last Name</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="splastname" id="splastname" pattern="{1,}" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="number" class="form-control" name="contact_num" id="contact_num" required>
                                        </div>
                                    </div>
