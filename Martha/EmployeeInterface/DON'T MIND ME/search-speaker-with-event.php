            ...
            <aside>
                <div id="sidebar"  class="nav-collapse ">
                    ...
                    <ul class="sidebar-menu" id="nav-accordion">
                        ...
                        <li class="sub-menu">
                            <a href="speakers-with-event.php" class="active">
                                <i class="fa fa-th"></i>
                ...
                <section class="wrapper site-min-height">
                    <div class="col-md-12">
                        <div class="content-panel">
                            ...
                            <ul class="nav pull-right top-menu">
                                <a type="button" class="btn btn-theme02" a href="speakers-with-event.php">BACK</a>
                            </ul>
                            ...
                            <table class="table">
                                ...
                                if(isset($_POST['submit-search'])){
                                    ...
                                    $sql = "SELECT 
                                                *,  TIME_FORMAT(start, '%H:%i %p') AS start,
                                                    TIME_FORMAT(end, '%H:%i %p') AS end
                                                    FROM
                                                        speaker
                                                            JOIN
                                                            ...
                                                            JOIN
                                                                event ON event.eventid = event_speaker.eventid
                                                                    WHERE
                                                                        speaker.spfirstname = '$search'
                                                                            OR speaker.splastname = '$search'
                                                                                OR event.eventname = '$search';";
